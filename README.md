...
本软件有桌面端+网页端。由于桌面端遇到一些问题（因为面包多更换了域名导致无法激活专业版），现在建议新老用户先用网页端。

## 如何使用本软件？
* 网页端访问 https://tern.1c7.me/#/

## 用户 QQ 群 （欢迎加群）
* 一群：982808006（人数: 493/500）   
* 二群：658774053（人数: 485/500）

## 重要通知 1 (2023-1-30)
* 机翻小助手网页版上线了！ https://tern.1c7.me/#/
* 网页版打开就能用，非常方便，欢迎尝试。
* 备注0: 版本 4.2.0 和更早的版本，都只有桌面端，必须下载使用，有些麻烦，建议先用网页版。
* 备注1：目前网页版只支持`字幕文件翻译`功能，语音转文字功能暂时没有。
* 备注2：网页版目前只支持百度这一家服务商。我接下来1-2周会先把 DeepL 服务商加上，然后加腾讯。然后根据用户反馈，再看看是继续加"字幕文件翻译"的服务商，还是去做"语音转文字"。

## 重要通知 2（关于桌面版）
* 由于2022年10月份面包多更换了域名，从 mianbaoduo.com 换成了 mbd.pub，所以桌面端的激活功能出了问题。
* 简单说就是版本 4.2.0（以及更早的版本）都无法激活。
* 2022年10月，11月，12月，2023年1月，开发者都在写代码，2023年1月30号发布了网页版。
* 我会给网页版添加更多翻译服务商。
* 语音转文字功能只能排期到后面。先把翻译的功能做好。

## 重要通知3
接下来的字幕翻译服务商更新路线是：
1. 百度 (已完成)
2. DeepL - 2023年2月7号 完成（已上线）
3. 腾讯 (投票数:2, 投票用户: =A3=)
4. 彩云(投票数: 2, 投票用户: 树风)
5. NAVER papago（用户说韩文翻译比较好）(投票数: 2, 投票用户: 宵夜， 🐳YOYO🐳)
6. 小牛 (投票数: 1, 投票用户: 熊小叔叔叔)
7. 谷歌 (投票数: 1, 投票用户: 伟★哥)
