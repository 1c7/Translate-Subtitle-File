...
* 打开就能使用，目前网页版只支持`字幕文件翻译`功能，语音转文字功能暂时没有。
* 网页版目前只支持百度这一家服务商。我接下来1-2周会先把 DeepL 服务商加上，然后加腾讯。
* 一共加大概5个服务商。

## 关于软件无法激活的重要通知 (通知时间 2022-10-27)
1. 本软件的激活机制依赖于面包多。
2. 面包多于2022年10月27号发了一个通知，原有域名 mianbaoduo.com 无法再使用，使用新域名 mbd.pub。
3. 所以软件的 4.1.0 版本（以及更早的版本）都无法激活了。
3. 预计11月~12月会更新一个版本，近期工作繁忙，而且软件的改动非常大，会尽快更新，请耐心等待。
...
## 用户 QQ 群
* 一群：982808006（人数: 488/500）   
* 二群：658774053（人数: 130/500）
