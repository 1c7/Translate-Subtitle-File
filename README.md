...
## 下载地址
* [下载 Windows 版本 (.zip)](https://tern-release.oss-cn-shenzhen.aliyuncs.com/Tern_Windows_3.2.0.zip)：解压 zip 后会得到一个文件夹，在里面找有图标的 .exe 双击执行即可    
* [下载 macOS 版本 (.dmg)](https://tern-release.oss-cn-shenzhen.aliyuncs.com/Tern_macOS_3.2.0.dmg)：双击 dmg，打开后把 App 拖入到应用程序里即可，和其他的 App 安装方法一致
