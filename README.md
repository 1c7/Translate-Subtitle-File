...
## 下载地址
* [下载 Windows 版本 (.zip)](https://tern-release.oss-cn-shenzhen.aliyuncs.com/Tern_Windows_2.6.0.zip)    
* [下载 macOS 版本 (.dmg)](https://tern-release.oss-cn-shenzhen.aliyuncs.com/Tern_macOS_2.6.0.dmg)
...
只要文件成功传给服务商，服务商开始处理了，那么就可以关掉本软件，    
过一阵子再回来看任务做完没，无需常开软件。    


<!--

## 如何使用？
1. 先"设置"。配置一家翻译服务商（如彩云小译） 
1. 拖入字幕文件 （文件后缀是 .srt .ass .vtt)
2. 选择服务商为"彩云小译", 然后选字幕源语言，如"英文"，然后选目标语言，如"中文"
3. 点击"开始翻译"按钮
